...
function NetworkService:ctor()
    ...
    mtEventDispatch():registerEvent(SocketTCP.EVENT_CONNECTED, handler(self,self.onConnectSuccess) );
    mtEventDispatch():registerEvent(SocketTCP.EVENT_CLOSE, handler(self,self.onConnectClosed) );
    mtEventDispatch():registerEvent(SocketTCP.EVENT_CLOSED, handler(self,self.onConnectClosed) );
    mtEventDispatch():registerEvent(SocketTCP.EVENT_CONNECT_FAILURE, handler(self,self.onConnectFailure) );
    mtEventDispatch():registerEvent(SocketTCP.EVENT_DATA, handler(self,self.onReceiveMessage) );
    mtEventDispatch():registerEvent(SocketTCP.EVENT_CLOSE_REASON, handler(self,self.onNetworkError));
